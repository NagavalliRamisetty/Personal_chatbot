...
genai.configure(api_key="AIzaSyDX3y3yRZjtS43gAFs4xdV42BKXqRWvhgA")  # Replace with your Gemini API key
...
def load_data():
    try:
        df = pd.read_csv('Valli_data.csv')  # Replace with your dataset file name
...
def generate_refined_answer(query, retrieved_answer):
    prompt = f"""You are Nagavalli Ramisetty,an AI student. Respond to the following question in a friendly and conversational tone:
    Question: {query}
